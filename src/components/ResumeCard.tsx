...
export function ResumeCard() {
  ...
  return (
    <section className="relative mx-3 my-6 overflow-hidden rounded-[2rem] bg-card px-6 py-10 shadow-sm sm:mx-6 sm:my-10 sm:px-10 sm:py-12 lg:px-14">
      ...
      <div className="mt-12">
        <h2 className="text-[clamp(2.3rem,10.5vw,2.6rem)] font-bold leading-[1.05] tracking-tight text-ink sm:text-[clamp(2.2rem,3.75vw,3.4rem)]">Hi, i&rsquo;m lily huang</h2>
